 				...
 				<div class="col-md-8">
 					<div class="card bg-primary">
 						<div class="card-body text-white">
 							...
 							<hr>
 							<p class=""><small><b>বিবরণঃ </b><i><?php echo $mov['description'] ?></i></small></p>
 							<p class=""><small><b>সময়কালঃ </b><i><?php echo $duration ?></i></small></p>
 						</div>
 					</div>
 					<div class="card bg-light mt-2">
 						<div class="card-body">
 							<h4>আপনার আসন এখানে রিজার্ভ করুন</h4>
 							<form action="" id="save-reserve">
 								<input type="hidden" name="movie_id" value="<?php echo $_GET['id'] ?>">
 								<div class="row">
 									<div class="form-group col-md-4">
 										<label for="" class="control-label">ডাকনাম</label>
 										<input type="text" name="lastname" required="" class="form-control">
 									</div>
 									<div class="form-group col-md-4">
 										<label for="" class="control-label">নাম</label>
 										<input type="text" name="firstname" required="" class="form-control">
 									</div>
 								<div class="form-group col-md-4">
 										<label for="" class="control-label">ফোন নাম্বার #</label>
 										<input type="text" name="contact_no" required="" class="form-control">
 									</div>
								</div>
 								<div class="row">
 								<div class="form-group col-md-4">
 									<label for="" class="control-label">হল নাম</label>
 								...
 								<div class="row">
 									<button class="col-md-2 btn btn-block btn-primary">বুক</button>
 								</div>
 							</form>
